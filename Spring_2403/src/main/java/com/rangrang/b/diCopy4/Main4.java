//package com.rangrang.b.diCopy4;
//
...
//        // map에서 iv의 이름에 맞는 객체를 찾아서 연결(객체 주소를 iv에 저장)
//        try {
...
//        // map에서 iv의 타입에 맞는 객체를 찾아서 연결(객체 주소를 iv에 저장)
//        try {
//            for (Object bean : map.values()) {
//                for (Field fld : bean.getClass().getDeclaredFields()) {
...
//            // 2. 반복문으로 클래스를 하나씩 읽어와서 @Component가 붙어 있는지 확인한다.
//            // 3. @Component가 붙어있으면 객체를 생성해서 map에 저장한다.
//            ClassLoader classLoader = AppContext.class.getClassLoader();
//            ClassPath classPath = ClassPath.from(classLoader);
//
//            Set<ClassPath.ClassInfo> set = classPath.getTopLevelClasses("com.rangrang.b.diCopy4");
//
...
//        return map.get(key);
//    }   // byName 객체 찾아 반환.
//    Object getBean(Class clazz) {   // byType 객체 찾아 반환.
